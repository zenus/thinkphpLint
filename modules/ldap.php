...
define('LDAP_DEREF_SEARCHING', 2);
define('LDAP_DEREF_FINDING', 3);
define('LDAP_DEREF_ALWAYS', 4);
define('LDAP_OPT_DEREF', 5);
define('LDAP_OPT_SIZELIMIT', 6);
define('LDAP_OPT_TIMELIMIT', 7);
...
define('LDAP_OPT_NETWORK_TIMEOUT', 21);
