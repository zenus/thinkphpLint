...
define('HW_API_REMOVE_NORMAL', 1);
define('HW_API_REMOVE_PHYSICAL', 1);
define('HW_API_REMOVE_REMOVELINKS', 1);
define('HW_API_REMOVE_NONRECURSIVE', 1);
define('HW_API_REPLACE_NORMAL', 1);
define('HW_API_REPLACE_FORCE_VERSION_CONTROL', 1);
define('HW_API_REPLACE_AUTOMATIC_CHECKOUT', 1);
define('HW_API_REPLACE_AUTOMATIC_CHECKIN', 1);
define('HW_API_REPLACE_PLAIN', 1);
define('HW_API_REPLACE_REVERT_IF_NOT_CHANGED', 1);
define('HW_API_REPLACE_KEEP_TIME_MODIFIED', 1);
define('HW_API_INSERT_NORMAL', 1);
define('HW_API_INSERT_FORCE_VERSION_CONTROL', 1);
define('HW_API_INSERT_AUTOMATIC_CHECKOUT', 1);
define('HW_API_INSERT_PLAIN', 1);
define('HW_API_INSERT_KEEP_TIME_MODIFIED', 1);
define('HW_API_INSERT_DELAY_INDEXING', 1);
define('HW_API_LOCK_NORMAL', 1);
define('HW_API_LOCK_RECURSIVE', 1);
define('HW_API_LOCK_SESSION', 1);
define('HW_API_CONTENT_ALLLINKS', 1);
define('HW_API_CONTENT_REACHABLELINKS', 1);
define('HW_API_CONTENT_PLAIN', 1);
define('HW_API_REASON_ERROR', 1);
define('HW_API_REASON_WARNING', 1);
define('HW_API_REASON_MESSAGE', 1);
